...
-Slicing de strings, utilizado para inverter uma string ('s[::-1]') e para extrair subconjuntos da mesma, permitindo comparar apenas partes específicas;<br> 
-Métodos embutidos como 'upper()' e 'lower()', para conversão entre maiúsculas e minúsculas;<br>
